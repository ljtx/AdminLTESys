...
{
    public class MenuController : AmbielBaseController
    {
        ...
        public IActionResult GetMenuTreeData()
        {
            ...
            {
                treeModels.Add(new TreeModel() { Id = menu.Id.ToString(), Text = menu.Name, Parent = menu.ParentId == string.Empty ? "#" : menu.ParentId.ToString() });
            }
