...
using System.Linq;
using Ambiel.AppService.DepartmentApp.Dtos;
using Ambiel.Domain.Entites;
using Ambiel.Domain.IRepositories;
using AutoMapper;

namespace Ambiel.AppService.DepartmentApp
{
    public class DepartmentAppService:IDepartmentAppService
    {
        ...
        {
            return Mapper.Map<List<DepartmentDto>>(_repository.GetAllList(it => it.Id != string.Empty).OrderBy(it => it.Code));
        }
        ...
        /// <returns></returns>
        public List<DepartmentDto> GetChildrenByParent(string parentId, int startPage, int pageSize, out int rowCount)
        {
